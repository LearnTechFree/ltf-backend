...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
    private static final Logger log = LoggerFactory.getLogger(JwtAuthenticatoinFilter.class);
        ...
        if(StringUtils.isNotEmpty(token) && token.startsWith(SecurityConstants.TOKEN_PREFIX)){
            try {
                ...
                Jws<Claims> parsedToken =
                        Jwts.parserBuilder().setSigningKey(signingKey).build().parseClaimsJws(token.replace(SecurityConstants.TOKEN_PREFIX,""));
